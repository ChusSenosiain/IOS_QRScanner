...
// KIFastQR
#define COCOAPODS_POD_AVAILABLE_KIFastQR
#define COCOAPODS_VERSION_MAJOR_KIFastQR 0
#define COCOAPODS_VERSION_MINOR_KIFastQR 3
#define COCOAPODS_VERSION_PATCH_KIFastQR 0
